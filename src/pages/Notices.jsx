...
const NOTICES = [
  {
    date: '2026-07-10', tag: '신기능', title: '지우기 모델을 골라 쓸 수 있어요',
    body: '이제 인페인팅에 쓰는 AI 모델을 직접 선택할 수 있습니다. 최상 품질의 LaMa, 실제 DeepFillv2(PyTorch), 직접 학습한 연구모델, 가벼운 고전 방식까지 — 화면 우측 상단 모델 선택기에서 버전을 바꿔가며 결과를 비교해 보세요. 선택은 다음에도 기억됩니다.',
  },
  {
    date: '2026-07-10', tag: '업데이트', title: '차량 번호판 인식이 훨씬 정확해졌어요',
    body: '번호판 탐지 엔진을 전용 AI 모델(YOLO11)로 교체했습니다. 이제 거리·주차장 사진에서도 번호판을 놓치지 않고 찾아내며, 항목마다 실제 신뢰도가 함께 표시됩니다. 베타 표기도 뗐어요.',
  },
  {
